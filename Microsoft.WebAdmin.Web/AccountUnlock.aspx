<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AccountUnlock.aspx.cs" Inherits="Microsoft.WebAdmin.Web.AccountUnlock" %>
    ...
    <fieldset>
        ...
        <table style="text-align: center; width: 88%;margin-left: auto;margin-right: auto;">
            ...
            <tr style="text-align: left;">
                ...
                <td  colspan="3"> 
                    <asp:Label ID="txtNotes" runat="server" Text="" Width="450px" Height="100px" Enabled="false"></asp:Label>
                </td> 
            </tr>
            <tr>
            ...
            <tr style="text-align: center;">
                <td colspan="8">
                    <asp:Button ID="BtnSubmit" runat="server" Text="解锁账号" OnClick="BtnSubmit_Click" />
                </td>
            </tr>
        </table>
    </fieldset>
