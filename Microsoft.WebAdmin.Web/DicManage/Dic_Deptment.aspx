<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Dic_Deptment.aspx.cs" Inherits="Microsoft.WebAdmin.Web.DicManage.Dic_Deptment" %>
            ...
            <tr>
                <td colspan="5" style="width: 100%;">
                    <asp:GridView ID="gvDetail" runat="server" OnPageIndexChanging="gvPhaseList_PageIndexChanging"
                        ...
                        <Columns>  
                            <asp:BoundField DataField="ID" HeaderText="序  号" Visible="false">
                           ...
                           <asp:BoundField DataField="description" HeaderText="部门备注">
                                <ItemStyle HorizontalAlign="Center" />
                                <HeaderStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td  style="width:300px;">
                                     <asp:DropDownList ID="ddlCompany" runat="server" Width="300px" DataTextField="CompanyName"
                                                       DataValueField="id">
                                    </asp:DropDownList> 
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td  style="width:300px;">
                                    <asp:TextBox ID="txtDeptName" runat="server" Width="300px"></asp:TextBox>
                                </td>
                            </tr> 
                            <tr>
                                <td style="width:100px;">
